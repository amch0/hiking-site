...
import { equipment } from "/data.json";
import { motion } from "framer-motion";

function Equipment() {
  const [terminologies] = useState(equipment);
    ...
    <main className="tech-bg pb-40 min-[410px]:pb-60 md:pb-40 lg:pb-0 pt-24 md:pt-40 lg:ps-12 xl:ps-40 lg:pt-52 2xl:h-screen">
      ...
      <section className="lg:flex lg:flex-col-2 lg:h-[527px]">
        ...
        >
          ...
          <picture>
            <img
              className="hidden lg:flex absolute xl:max-h-[400px] 2xl:max-h-[500px] 3xl:max-h-[600px] right-0 inset-y-68"
              src={images.portrait}
              alt={name}
            />
          </picture>
